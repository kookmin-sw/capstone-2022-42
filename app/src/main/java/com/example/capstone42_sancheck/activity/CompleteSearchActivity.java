...
public class CompleteSearchActivity extends AppCompatActivity implements
        OnMapReadyCallback,
    ...
    public ArrayList<LatLng> getJsonData(){
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                try{
                    ...
                    mapPoints.add(new LatLng(Double.parseDouble(startArray[1]), Double.parseDouble(startArray[0])));
                    ...
                    mapPoints.add(new LatLng(Double.parseDouble(endArray[1]), Double.parseDouble(endArray[0])));
...
//                    Manifest.permission.ACCESS_FINE_LOCATION, true)L
    ...
    public void oneMarker() {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(CompleteSearchActivity.this, "마커", Toast.LENGTH_LONG);
                return false;
            }
        });
    ...
    GoogleMap.OnMarkerClickListener markerClickListener = new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            Toast.makeText(CompleteSearchActivity.this, "위치 : "+markerId+"("+location.latitude+" "+location.longitude+")", Toast.LENGTH_SHORT).show();
            return false;
        }
    };
