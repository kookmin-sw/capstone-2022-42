...
public class CartSearchActivity extends AppCompatActivity implements
        OnMapReadyCallback,
...
//                    Manifest.permission.ACCESS_FINE_LOCATION, true)L
    ...
    public void oneMarker() {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(CartSearchActivity.this, "마커", Toast.LENGTH_LONG);
                return false;
            }
        });
    ...
    GoogleMap.OnMarkerClickListener markerClickListener = new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            Toast.makeText(CartSearchActivity.this, "위치 : "+markerId+"("+location.latitude+" "+location.longitude+")", Toast.LENGTH_SHORT).show();
            return false;
        }
    };
